        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="POST" action="<?= base_url('Page/add_job') ?>" enctype="multipart/form-data">
              <input type="hidden" name="username" autocomplete="off" value="<?= $bio[0]->username ?>" class="form-control">
               <div class="row mb-3">
                    <label class="col-sm-2 col-form-label">Company Name</label>
                    <div class="col-sm-4">
                     <input type="text" class="form-control" required="" autocomplete="off" name="nama_perusahaan">
                    </div>

                    <label class="col-sm-2 col-form-label">Last Position</label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" required="" autocomplete="off" name="jabatan">
                    </div>
              ...
              <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                     <input type="text" class="form-control" required="" autocomplete="off" name="durasi">
                    </div>

                    <label class="col-sm-2 col-form-label">Reason to Leave</label>
                    <div class="col-sm-4">
                      <textarea  class="form-control" required="" autocomplete="off" name="alasan"></textarea>
                    </div>
                  ...
                  <?php
                      ...
                      foreach ($job as $j) { ?>
                        <tr>
                          ...
                          <td><?= $j->alasan ?></td>
                          <td>
                            <a href="<?= base_url()?>Page/edit_job?id_riwayatkerja=<?= $j->id_riwayatkerja ?>" class="btn btn-sm btn-success" onclick="return confirm('Ubah <?= $j->nama_perusahaan?> ?')"><i class="bi bi-pen"></i></a>
